...
//!
//! Template-based conversion (weights → program), weight providers (SafeTensors, GGUF),
//! LoRA merging, MoE splitting, and pipeline orchestration have moved to the
//! `ironmill-compile` crate.
