...
//!
//! Provides a format-agnostic interface for loading model weights from
//! SafeTensors, GGUF, or other weight-only formats. Architecture templates
//! consume [`WeightProvider`] without knowing the underlying format.
