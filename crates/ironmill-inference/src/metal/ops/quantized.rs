...
use super::{GroupSizePipelines, LinearKernelKind, METAL_MAX_THREADS_PER_THREADGROUP};
...
pub struct AffinePipelines {
    ...
    /// INT4 matvec: 8 rows/TG, 64 threads, inline scale/zero. GS-specialized.
    pub matvec_int4: GroupSizePipelines,
    /// INT4 matmul: tiled prefill with inline scale/zero. GS-specialized.
    pub matmul_int4: GroupSizePipelines,
    /// Fused FFN gate+up+activation INT4. GS-specialized.
    pub fused_ffn_gate_up_act_int4: GroupSizePipelines,
    /// Batched affine INT4 matvec (gate+up). GS-specialized.
    pub batched_matvec_int4: GroupSizePipelines,
    /// GDN batched affine INT4 matvec (4 projections). GS-specialized.
    pub gdn_batched_matvec_int4: GroupSizePipelines,
    /// INT4×Q8 integer dot product matvec. GS-specialized.
    pub matvec_int4xq8: GroupSizePipelines,
    /// INT8 matvec: 8 rows/TG, 64 threads, inline scale/zero. GS-specialized.
    pub matvec_int8: GroupSizePipelines,
    /// INT8 matmul: tiled prefill with inline scale/zero. GS-specialized.
