//! Model loading, calibration, and projection dispatch helpers.
//!
//! The [`MetalInference`] struct and trait impls live in [`super::engine`].
//! This module contains the loading code (weight upload, KV cache setup,
//! pipeline compilation) and calibration-mode pipeline.
