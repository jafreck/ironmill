...
/// Available via [`InferenceEngine::model_info()`](crate::engine::InferenceEngine::model_info).
#[non_exhaustive]
#[derive(Debug, Clone)]
pub struct ModelInfo {
    ...
    /// Used by [`TokenStream`](crate::generate::TokenStream) when no explicit
    /// stop tokens are provided.
