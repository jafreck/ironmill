...
func printTable(_ results: BenchResults) {
    ...
    print(String(format: "  %-24s %s", "Model load time:", fmt(results.loadTimeMs)))
    print(String(format: "  %-24s %s", "First inference:", fmt(results.firstInferenceMs)))
    print(String(format: "  %-24s %d (warmup: %d)", "Iterations:", results.iterations, results.warmup))
    print(String(repeating: "─", count: 44))
    print(String(format: "  %-24s %s", "Mean:", fmt(results.meanMs)))
    print(String(format: "  %-24s %s", "Median (p50):", fmt(results.medianMs)))
    print(String(format: "  %-24s %s", "p95:", fmt(results.p95Ms)))
    print(String(format: "  %-24s %s", "p99:", fmt(results.p99Ms)))
    print(String(format: "  %-24s %s", "Min:", fmt(results.minMs)))
    print(String(format: "  %-24s %s", "Max:", fmt(results.maxMs)))
    print(String(repeating: "─", count: 44))
    print(String(format: "  %-24s %s", "Total time:", fmt(results.totalTimeMs)))
    print("")
}
